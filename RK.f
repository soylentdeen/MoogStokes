...
c*****  Assemble the Opacity matrix (K)
         ...
         phiQ(i) = phi_Q/kapref(i)
         phiU(i) = phi_U/kapref(i)
         phiV(i) = phi_V/kapref(i)
         psiQ(i) = psi_Q/kapref(i)
         psiU(i) = psi_U/kapref(i)
         psiV(i) = psi_V/kapref(i)

c         kappa(1,1,i)=kaptot(i)/kapref(i)
c         kappa(1,2,i)=phi_Q/kapref(i)
c         kappa(1,3,i)=phi_U/kapref(i)
c         kappa(1,4,i)=phi_V/kapref(i)
c         kappa(2,1,i)=phi_Q/kapref(i)
c         kappa(2,2,i)=kaptot(i)/kapref(i)
c         kappa(2,3,i)=psi_V/kapref(i)
c         kappa(2,4,i)=(-1.0*psi_U)/kapref(i)
c         kappa(3,1,i)=phi_U/kapref(i)
c         kappa(3,2,i)=(-1.0*psi_V)/kapref(i)
c         kappa(3,3,i)=kaptot(i)/kapref(i)
c         kappa(3,4,i)=psi_Q/kapref(i)
c         kappa(4,1,i)=phi_V/kapref(i)
c         kappa(4,2,i)=psi_U/kapref(i)
c         kappa(4,3,i)=(-1.0*psi_Q)/kapref(i)
c         kappa(4,4,i)=kaptot(i)/kapref(i)
...
c      call spline(xref, kappa(1,1,:), ntau, bgfl, bgfl, dk11)
c      call spline(xref, kappa(1,2,:), ntau, bgfl, bgfl, dk12)
c      call spline(xref, kappa(1,3,:), ntau, bgfl, bgfl, dk13)
c      call spline(xref, kappa(1,4,:), ntau, bgfl, bgfl, dk14)
c      call spline(xref, kappa(2,1,:), ntau, bgfl, bgfl, dk21)
c      call spline(xref, kappa(2,2,:), ntau, bgfl, bgfl, dk22)
c      call spline(xref, kappa(2,3,:), ntau, bgfl, bgfl, dk23)
c      call spline(xref, kappa(2,4,:), ntau, bgfl, bgfl, dk24)
c      call spline(xref, kappa(3,1,:), ntau, bgfl, bgfl, dk31)
c      call spline(xref, kappa(3,2,:), ntau, bgfl, bgfl, dk32)
c      call spline(xref, kappa(3,3,:), ntau, bgfl, bgfl, dk33)
c      call spline(xref, kappa(3,4,:), ntau, bgfl, bgfl, dk34)
c      call spline(xref, kappa(4,1,:), ntau, bgfl, bgfl, dk41)
c      call spline(xref, kappa(4,2,:), ntau, bgfl, bgfl, dk42)
c      call spline(xref, kappa(4,3,:), ntau, bgfl, bgfl, dk43)
c      call spline(xref, kappa(4,4,:), ntau, bgfl, bgfl, dk44)
